    ...
    >
      ...
      >
        <div className="flex h-full flex-col-reverse gap-2">
          {/* Dock */}
          <div className="bg-sidebar text-sidebar-foreground border-sidebar-border mx-auto flex flex-row gap-1 rounded p-2">
            {[1, 2, 3, 4].map((i) => (
              <div
                key={i}
                className={cn(
...
export { PresetPreviewCard, PresetDockPreviewCard }
